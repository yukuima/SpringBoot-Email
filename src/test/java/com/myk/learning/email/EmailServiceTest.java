package com.myk.learning.email;

import com.myk.learning.email.service.MailService;
...
public class EmailServiceTest {
    ...
    public void sendHtmlMailTest(){
        String content="<html>\n" +
                ...
                "</body>\n" +
                "</html>";
        mailService.sendHtmlMail("xxxxxx@163.com","test html mail",content);
    }
    ...
    public void sendInlineResourceMail() {
        ...
        mailService.sendInlineResourceMail("xxxxxx@163.com", "主题：这是有图片的邮件", content, imgPath, rscId);
    }
    ...
    public void sendTemplateMail() {
        ...
        mailService.sendTemplateMail("xxxxxx@163.com","主题：这是模板邮件",
